...
2. 在模型写完并完成训练后，请联系我获取测试集，然后用自己训好的模型推断获得结果，处理成要求的格式发给我；
3. 我会计算大家的测试结果，将排名公开到Github的Repository中，并一并公开代码；
4. 最后将全部代码+README.md说明文件打包成以自己学号命名的压缩包发给我；
5. 前三个任务可以参考开源代码，但是最后提交的代码必须是自己写的；
6. 禁止使用除了训练集以外的任何数据用于训练，禁止使用验证集、测试集进行训练。
...
| 序号 | 学号       | 准确率 | 提交时间      | 说明  |
| ---- | ----------| ------ | -------------|------|
| 1    | 20125222  | 88.84% | 2020年10月8日|这是第二版代码的结果|
| 2    | 20120419  | 90.10% | 2020年10月8日|这是第二版代码的结果|
| 3    | 20120376  | 90.88% | 2020年10月9日|这是第二版代码的结果|
| 4    | 20125185  | 90.16% | 2020年10月10日|这是第二版代码的结果|
| 5    | 20125197  | 87.77% | 2020年10月10日|使用了word2vec训练的词向量|
| 6    | 20125265  | 88.84% | 2020年10月10日|这是第二版代码的结果|
| 7    | 20120374  | 91.06% | 2020年10月10日|添加了一层额外的BiLSTM|
| 8    | 20125261  | 85.12% | 2020年10月11日||
